...
export default function Hero() {
  ...
  return (
    ...
    <section aria-label="Promotional hero" className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-pink-950 to-slate-900">

      {/* Background decoration */}

      <div className="absolute inset-0 overflow-hidden pointer-events-none">

        <div className="absolute -top-40 -right-40 w-96 h-96 bg-pink-600/20 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight">
              ...
              <span className="text-pink-400">You Will Love</span>
